...
中国人民大学智能信息检索课题组（**{{ site.name }}**）关注于基于人工智能的信息检索（Infomation Retrieval）模型与系统研发，现有成员包括专任教师2人，博士研究生、硕士研究生和本科生20余人。

**欢迎对大模型时代信息检索技术感兴趣的同学与我们联系(E-mail: junxu@ruc.edu.cn)**

**期待大家的加入，让我们共同推进信息检索技术的进步。**

<!-- 下面是图片 -->
<div markdown="0">
    <img src="{{ site.url }}{{ site.baseurl }}/images/slider_pic/tuanjian1.jpeg" alt="Team Photo" style="width: 100%" />
</div>


<div style="margin-top: 40px;">
感谢长期以来对本课题组提供支持与合作的项目（
国家重点研发计划、国家自然科学基金）和单位（华为、字节、阿里、腾讯、快手、北京智源人工智能研究院）。
<figure>
